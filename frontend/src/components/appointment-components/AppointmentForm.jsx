...
function AppointmentForm() {
	...
	function handleChange(event) {
		...
		setAppointmentInput((prev) => ({ ...prev, [name]: value }));
	}
		...
		if (validator.validate(appointmentInput.bookingEmail)) {
			...
			try {
				...
				if (res.status == 200) {
					...
					setBookingDetails(appointmentInput); // Store the booking details
				...
				<>
					<>
						<p className="formHeading">
							Book an appointment with us by filling the form
							below
						</p>
						...
						>
							...
							<div className="typeOfServiceInput formSubDiv inputFieldDiv">
								...
								>
									...
									<option value="Beard trimming">
										Beard trimming
									</option>
									<option value="Hair trimming">
										Hair trimming
									</option>
									<option value="Hair braiding">
										Hair braiding
									</option>
